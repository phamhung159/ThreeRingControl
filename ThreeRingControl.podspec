...
beautifully rendered math equations in iOS applications.
  ...
  s.author             = { "phamhung" => "phamhung159@gmail.com" }
  # Or just: s.author    = "phamhung"
  # s.authors            = { "phamhung" => "phamhung159@gmail.com" }
  # s.social_media_url   = "http://twitter.com/phamhung"
  ...
  s.source       = { :git => "http://EXAMPLE/ThreeRingControl.git", :tag => "master" }
  ...
  s.source_files  = "ThreeRingControl/**/*.{h,m}"
